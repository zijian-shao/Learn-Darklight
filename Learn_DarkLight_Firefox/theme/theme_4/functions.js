function initTheme() {
    ...
    var colorData = {
        default: ['#fffaaa', '#ffea30', '#fdd54f', '#e4b429', '#fdd54f', '#222', '#999', '#eee', '#f6f6f6', '#000000', '#fdd54f', '#f4ad24', '#333333', '#333333', '#fdd54f', '#fdd54f', '#fdd54f', '#333333', 'rgba(0,0,0,0.7)', '#f9fafb', '#d3d9e3', '#565a5c', '#333333', '#333333', '#ffffff', 'rgba(0,0,0,0.2)'],
