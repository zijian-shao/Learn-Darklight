function initOptions() {
    ...
    function bindEvents() {
        ...
        $('.share-link').on('click', function (e) {
            ...
            if (openIn == 'popup') {
                ...
                $('#clipboard-input').val('https://www.zijianshao.com/dlight/sharelink/?platform=safari').select();
    ...
    $(window).load(function () {
        ...
        // version #
        // $('#darklight-version').text(safari.extension.displayVersion);

        safari.self.addEventListener('message', function (event) {
            if (event.name == 'version') {
                $('#darklight-version').text(event.message);
            }
        }, false);
        safari.self.tab.dispatchMessage('getVersion');
